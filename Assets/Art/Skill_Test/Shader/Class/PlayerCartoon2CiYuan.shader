...
Shader "cokey/other/PlayerCartoon2CIYuan" {
    Properties {
        ...
        [MaterialToggle] _2UV ("2 UV", Float ) = 0
        ...
        _LMU_Speed ("LMU_Speed", Float ) = 0
        _LMV_Spped ("LMV_Spped", Float ) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_67 = ((_HighLine+objPos.g)-i.posWorld.g);
                float node_9564 = saturate(node_67);
        ...
        Pass {
            ...
            uniform fixed _GampOne;
            uniform float _LMU_Speed;
            uniform float _LMV_Spped;
            uniform fixed _2UV;
            struct VertexInput {
                float4 vertex : POSITION;
                float3 normal : NORMAL;
...
////// Emissive:
                float4 node_6898 = _Time;
                float node_4510 = (node_6898.g*_LMV_Spped);
                float2 node_982 = (float2((node_6898.g*_LMU_Speed),node_4510)+lerp( i.uv0, float2((objPos.r-i.posWorld.r),node_67), _2UV ));
                float4 _LightMask_var = tex2D(_LightMask,TRANSFORM_TEX(node_982, _LightMask));
