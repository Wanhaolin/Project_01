...
Shader "Whl/Fx/FxStand"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_cast_0 = (saturate( temp_output_114_0 )).xxxx;
			float4 temp_cast_1 = (temp_output_114_0).xxxx;
			UnityGI gi119 = gi;
			...
			#ifdef _USELMP_ON
				float4 staticSwitch132 = ( saturate( min( temp_cast_1 , ( _LmpIntensity * float4( LightMap151 , 0.0 ) * _LmpColor ) ) ) + float4( ( max( (LightMap151*0.3 + -0.3) , float3( 0,0,0 ) ) * _LightMul ) , 0.0 ) );
			#else
				float4 staticSwitch132 = temp_cast_0;
			#endif
			float4 lerpResult5 = lerp( ShaowColor93 , BaseColor96 , staticSwitch132);
			float4 temp_output_105_0 = max( lerpResult5 , float4( 0,0,0,0 ) );
			...
			#ifdef UNITY_PASS_FORWARDBASE
				float3 staticSwitch84 = temp_cast_6;
			#else
				float3 staticSwitch84 = temp_output_71_0;
			#endif
			float3 LightColor78 = staticSwitch84;
			c.rgb = ( staticSwitch110 * float4( LightColor78 , 0.0 ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18935
-1433;172;1372;847;-347.5308;725.259;1.671859;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;24;-2523.508,24.15645;Inherit;False;22;WorldNormal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1;-2315.352,27.35949;Inherit;False;Half Lambert Term;-1;;1;86299dc21373a954aa5772333626c9c1;0;1;3;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;4;-4506.395,-1317.605;Inherit;False;Property;_ShaowColor;ShaowColor;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3490566,0.2607697,0.2087754,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;62;-3477.179,-1102.064;Inherit;True;Property;_DiffuseTex;DiffuseTex;3;0;Create;True;0;0;0;False;0;False;-1;None;a020ee7462752a54c9de647d3019f702;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;3;-3443.39,-1318.414;Inherit;False;Property;_BaseColor;BaseColor;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.350089,0.393656,0.4150943,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;105;336.9193,-124.2798;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;106;505.0117,99.2092;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;79;1539.165,186.4002;Inherit;True;78;LightColor;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;165;1786.016,-17.97003;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;155;1427.058,44.40941;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2109.912,-251.7161;Float;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;Whl/Fx/FxStand;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;True;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;False;0;False;Opaque;;Geometry;ForwardOnly;18;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;0;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0.06;0,0,0,1;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;165;1;79;0
WireConnection;155;1;156;0
WireConnection;155;2;157;0
WireConnection;0;13;165;0
ASEEND*/
//CHKSM=3CF0FD1B9CB9917BFC97E072A7A8444660685CEC