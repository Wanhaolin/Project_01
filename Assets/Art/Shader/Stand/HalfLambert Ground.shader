...
Shader "ASE/HalfLambertGround"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#ifdef UNITY_PASS_FORWARDBASE
				float3 staticSwitch84 = temp_cast_4;
			#else
				float3 staticSwitch84 = temp_output_71_0;
			#endif
			float3 LightColor78 = staticSwitch84;
			float4 temp_output_105_0 = max( ( lerpResult5 * float4( LightColor78 , 0.0 ) ) , float4( 0,0,0,0 ) );
...
/*ASEBEGIN
Version=18935
-1433;172;1372;847;758.598;634.8136;1.497202;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;79;-343.5541,92.90411;Inherit;True;78;LightColor;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;86;-3.849382,-142.7356;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=F402B547069FD7BB8D38D9F2AC28A6872A38848F