...
//			}
		...
		public void DrawCreditsGUI(){
			...
			EditorGUILayout.Separator();
			FlexHorizontal(()=>{
				if( GUILayout.Button( "Start page", GUILayout.Height( 30f ), GUILayout.Width( 190f ) ) ) {
		...
		public void DrawPreviewPanel( Rect r ) {
			...
			if(GUI.Button(btnRect,"Start page",btnStyle)){
			...
			if( GUI.Button( btnRect, "Compile", btnStyle ) ) {
